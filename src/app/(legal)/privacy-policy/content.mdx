...
<Heading2 $margin={48}>What information do we collect?</Heading2>
...
<Heading2 $margin={48}>How do we use your information?</Heading2>
...
<Heading2 $margin={48}>Will your information be shared with anyone?</Heading2>
...
<Heading3 $margin={48}>With whom could my data be shared?</Heading3>
...
<Heading2 $margin={48}>How long do we keep your information?</Heading2>
...
<Heading2 $margin={48}>How do we keep your information safe?</Heading2>
...
<Heading2 $margin={48}>Do we collect information from minors?</Heading2>
...
<Heading2 $margin={48}>What are my privacy rights?</Heading2>
